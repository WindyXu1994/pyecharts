...
'''
说明：
1.使用Pyecharts工具需要最基本的Python基础
2.阅读本文档之前需要阅读上方列出的 官方帮助文档 和 简易教程，建立对Pyecharts"是什么、怎么用"的初步认识
3.在有了一定认识的基础上，可结合本文档快速使用Pyecharts

特点：

1.官方帮助文档：
内容全面（包括Pyecharts安装、扩展、复杂功能说明等），模块化展示各功能，丰富案例库

2.简易教程：
便于初学者认识、上手模仿，内容较全面

3.快速使用文档（本文档）：
a) 对于常用且变化多样的几种图表进行详细说明
b) 按照“定义数据、添加可用配件、调整格式”的日常使用顺序，逐步细化介绍
c) 在“调整格式”中，列出了常用参数，并对每一个模块附上了对应的官方说明链接
...
line=(
    ...
    .add_yaxis(
        ...
        # 线型                                                                                     https://pyecharts.org/#/zh-cn/series_options?id=linestyleopts%ef%bc%9a%e7%ba%bf%e6%a0%b7%e5%bc%8f%e9%85%8d%e7%bd%ae%e9%a1%b9
